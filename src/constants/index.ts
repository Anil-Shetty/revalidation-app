...
export const NOTIFICATION_MESSAGES = {
  CONFIGURATION_SCREEN: {
    SUBMIT_FAILED: 'There was an error saving your configuration. Please check the endpoint and selected content models, then try again.'
  },
  PAGE: {
    ...
    REVALIDATION_FAILED: 'Unable to revalidate the page. Ensure the page exists and try again. If the problem persists, reach out to the dev team.',
